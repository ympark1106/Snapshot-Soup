...
def train():
    ...
    if args.data == 'cifar10':
        train_loader, valid_loader = cifar10.get_train_valid_loader(batch_size=batch_size, augment=True, random_seed=42, valid_size=0.1, shuffle=True, num_workers=4, pin_memory=True, get_val_temp=0, data_dir=data_path)
    elif args.data == 'cifar100':
        train_loader, valid_loader = cifar100.get_train_valid_loader(data_dir=data_path, augment=True, batch_size=128, valid_size=0.1, random_seed=42, shuffle=True, num_workers=4, pin_memory=True)
    elif args.data == 'cub':
        ...
        train_loader, valid_loader, _ = bloodmnist.get_dataloader(batch_size=batch_size, download=True, num_workers=4)
    elif args.data == 'pathmnist':
        train_loader, valid_loader, _ = pathmnist.get_dataloader(batch_size=batch_size, download=True, num_workers=4)
    elif args.data == 'retinamnist':    
        train_loader, valid_loader, _ = retinamnist.get_dataloader(batch_size=batch_size, download=True, num_workers=4)
    elif args.data == 'eyepacs':
        train_loader, valid_loader, _ = eyepacs.get_dataloaders(data_path, batch_size=batch_size, pin_memory=True, num_workers=16)
    elif args.data == 'tinyimagenet':
        train_loader, valid_loader, _ = tinyimagenet.get_dataloaders(data_path, batch_size=batch_size, num_workers=4, pin_memory=True, val_split=0.1)
